...
<body>
    ...
    <div class="pakalpojums-info">
        <div class="container">
            <div class="row">
                <div class="col-6"><img src="assets/img/large.jpg">
                    <h2 class="pakalpojums-nt">Nosaukums</h2>
                    <h3 class="pakalpojums-nt">Kategorija</h3>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col"><button class="btn btn-primary btn-block" type="submit">Uzrakstiet e-ziņu</button></div>
                    </div>
                    <div class="row">
                        <div class="col-6 pakalpojumi-row-button"><button class="btn btn-primary btn-block" type="submit">Rediģet</button></div>
                        <div class="col-6 pakalpojumi-row-button"><button class="btn btn-primary btn-block" type="submit">Dzēst</button></div>
                    </div>
                </div>
                <div class="col-6">
                    <h2></h2>
    ...
    <div class="atsauksmes">
        <div class="container">
            ...
            <div class="row">
                <div class="col-2 atsauksme-bilde"><img src="assets/img/0_200.png" class="atsauksme-bilde"></div>
                <div class="col-7">
                    <p>Atsauksmes teksts</p>
                </div>
                <div class="col button7"><button class="btn btn-primary btn-block" type="submit">Rediģet</button><button class="btn btn-primary btn-block" type="submit">Dzēst</button></div>
            </div>
        </div>
    </div>
