...
<body>
    ...
    <div class="container new-password">
        <div class="row">
            <div class="col-6">
                <h3 class="profile-red-info">Ievadiet savu e-pastu un mēs iesutīsim Jums hipersaiti paroles maiņai:</h3>
            </div>
            <div class="col-4">
                <form placeholder="E-pasts"><input class="form-control" type="email" placeholder="E-pasts"></form>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-2"></div>
        <div class="col-4"><button class="btn btn-primary btn-block" type="submit">Atsutīt</button></div>
        <div class="col-4"><button class="btn btn-primary btn-block" type="submit">Atcelt</button></div>
        <div class="col-2"></div>
    </div>
