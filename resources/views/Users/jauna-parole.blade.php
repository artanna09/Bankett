...
<body>
    ...
    <div class="container new-password">
        <div class="row">
            <div class="col-6">
                <h3 class="profile-red-info">Jauna parole:</h3>
            </div>
            <div class="col-4">
        ...
        <div class="row">
            <div class="col-6">
                <h3 class="profile-red-info">Atkārtota parole:</h3>
            </div>
            <div class="col-4">
                <form><input class="form-control" type="password"></form>
            </div>
        ...
        <div class="row">
            <div class="col-2"></div>
            <div class="col-4"><button class="btn btn-primary btn-block" type="submit">Saglabāt</button></div>
