        ...
        <div class="container"><a class="navbar-brand" href="#"><img src="assets/img/banquet.png" class="bankett-icon">Bankett</a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div
                ...
                <ul class="nav navbar-nav mr-auto">
                    ...
                    <li class="dropdown show"><a class="dropdown-toggle nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="true" href="#" style="color:rgb(252,242,229);">Profils</a>
                        <div class="dropdown-menu show" role="menu"><a class="dropdown-item" role="presentation" href="#">Mans profils</a><a class="dropdown-item" role="presentation" href="#">Iziet</a></div>
                    </li>
    ...
    <div id="profile-red">
        <div class="container">
            <div class="row row-profile-red">
                <div class="col-4">
                    <h4 class="profile-red-info">Vārds:</h4>
                </div>
                <div class="col-4">
            ...
            <div class="row row-profile-red">
                <div class="col-4">
                    <h4 class="profile-red-info">Uzvārds:</h4>
                </div>
                <div class="col-4">
                    <form><input class="form-control" type="text"></form>
                </div>
            ...
            <div class="row row-profile-red">
                <div class="col-4">
                    <h4 class="profile-red-info">Parole:</h4>
                </div>
                <div class="col-4">
                    <form><input class="form-control" type="password"></form>
                </div>
            </div>
            <div class="row row-profile-red">
                <div class="col-4">
                    <h4 class="profile-red-info">E-pasts:</h4>
                </div>
                <div class="col-4">
